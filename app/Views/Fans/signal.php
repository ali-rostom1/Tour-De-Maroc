...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            ...
            <!-- Form -->
            <form action="/signal/submit" method="POST" class="bg-white rounded-lg shadow-lg p-6 space-y-6">
    <!-- Type d'erreur -->
    <div>
        <label for="error-type" class="block text-sm font-medium text-gray-700 mb-2">Type d'erreur</label>
        <select name="error-type" id="error-type" required class="w-full rounded-lg border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500">
    ...
    <div>
        ...
        <input type="text" name="stage" id="stage" required class="w-full rounded-lg border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500" placeholder="ex: Étape 3">
    </div>

    <!-- Coureur -->
    <div>
        <label for="rider" class="block text-sm font-medium text-gray-700 mb-2">Coureur concerné</label>
        <input type="text" name="rider" id="rider" required class="w-full rounded-lg border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500" placeholder="Nom du coureur">
    </div>

    <!-- Description -->
    <div>
        <label for="description" class="block text-sm font-medium text-gray-700 mb-2">Description de l'erreur</label>
        <textarea name="description" id="description" required rows="4" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500" placeholder="Décrivez l'erreur en détail..."></textarea>
    </div>

    <!-- Source correcte -->
    <div>
        <label for="source" class="block text-sm font-medium text-gray-700 mb-2">Source de la correction</label>
        <input type="text" name="source" id="source" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500" placeholder="URL ou référence officielle">
    </div>

    <!-- Contact -->
    <div>
        <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Votre email (optionnel)</label>
        <input type="email" name="email" id="email" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500" placeholder="email@exemple.com">
