...
<head>
    ...
    <meta name="description" content="Tour de Morocco 2025 - Cyclist Dashboard">
    <title>Tour de Morocco 2025 - Cyclist Dashboard</title>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
                <div class="flex items-start space-x-6">
                    <div class="relative">
                        ...
                        <button class="absolute bottom-2 right-2 bg-[#FED100] p-2 rounded-full">
                            <i class="fas fa-camera"></i>
                        </button>
                    </div>
                    <div class="flex-1">
                        <div class="flex justify-between items-start">
                            ...
                            <button class="bg-[#004D98] text-white px-4 py-2 rounded-lg">
